...
All browser traffic is automatically routed through the [Caido proxy](/tools/proxy), giving Strix full visibility into every request and response. This enables:
