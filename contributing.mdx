...
Prompt modules are specialized knowledge packages that enhance agent capabilities. They live in `strix/prompts/`.

### Categories

| Directory | Purpose |
|-----------|---------|
| `/vulnerabilities` | Vulnerability-specific testing knowledge |
| `/frameworks` | Framework-specific guidance (FastAPI, Next.js) |
| `/technologies` | Technology-specific patterns (Firebase, Supabase) |
| `/protocols` | Protocol knowledge (GraphQL) |
